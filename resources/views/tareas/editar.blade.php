    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <?php } ?>
                ...
                @endif
                {{ Form::open(array('url' => 'tareas/actualizar/'.$tarea->id)) }}
                ...
                <div class="row">               
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            {{Form::textarea('objetivo', $tarea->tarea, array('class'=>'form-control', 'rows'=>3, 'placeholder'=>'descripcion de la tarea', 'autocomplete'=>'off', 'disabled'))}}
                        </div>
                        @if( $errors->has('tarea') )
                            <div class="alert alert-danger">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {{Form::textarea('objetivo', $tarea->objetivo, array('class'=>'form-control', 'rows'=>3, 'placeholder'=>'objetivo de la tarea', 'autocomplete'=>'off', 'disabled'))}}
                        </div>
